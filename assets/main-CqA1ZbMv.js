import"./modulepreload-polyfill-EeOZK34R.js";import"./main-DSuioSGK.js";var e=null;window.mostraStatisticheCampionato=t;function t(){let e=document.getElementById(`modalStatsCampionato`);e||(e=document.createElement(`div`),e.id=`modalStatsCampionato`,e.className=`popup`,e.style.display=`none`,e.innerHTML=`
            <style>
                /* Stili per lo Switch */
                .switch-container {
                    display: flex;
